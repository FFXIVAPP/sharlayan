...
namespace Sharlayan.Models.ReadResults {
    public class JobResourceResult {
        ...
        internal JobResourceResult(byte[] sourceBytes) {
            ...
            //Paladin = new PaladinResources(this);
            //Warrior = new WarriorResources(this);
            //Darkknight = new DarkknightResources(this);
            //Gunbreaker = new GunbreakerResources(this);
            //Monk = new MonkResources(this);
            //Dragoon = new DragoonResources(this);
            //Ninja = new NinjaResources(this);
            //Samurai = new SamuraiResources(this);
            //Bard = new BardResources(this);
            //Machinist = new MachinistResources(this);
            //Dancer = new DancerResources(this);
            //Summoner = new SummonerResources(this);
            //BlackMage = new BlackMageResources(this);
            //RedMage = new RedMageResources(this);
            //WhiteMage = new WhiteMageResources(this);
            //Scholar = new ScholarResources(this);
            //Astrologian = new AstrologianResources(this);
        }
        ...
        public sealed class MonkResources {
            public TimeSpan Timer { get; }
            public int GreasedLightning { get; }
            public int Chakra { get; }

            internal MonkResources(JobResourceResult result) {
                Timer = TimeSpan.FromMilliseconds(BitConverter.ToUInt16(result.Data, result.Offsets.Monk.Timer));
                GreasedLightning = result.Data[result.Offsets.Monk.GreasedLightning];
