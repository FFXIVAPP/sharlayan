    ...
    public partial class Reader {
        ...
        private (uint mapID, uint mapIndex, uint mapTerritory) GetMapInfo() {
            ...
            if (this._memoryHandler.Scanner.Locations.ContainsKey(Signatures.MapInformationKey)) {
                try {
                    mapTerritory = this._memoryHandler.GetUInt32(this._memoryHandler.Scanner.Locations[Signatures.MapInformationKey]);
            ...
            if (this._memoryHandler.Scanner.Locations.ContainsKey(Signatures.ZoneInformationKey)) {
                try {
                    mapIndex = this._memoryHandler.GetUInt32(this._memoryHandler.Scanner.Locations[Signatures.ZoneInformationKey], 8);
